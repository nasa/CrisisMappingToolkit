...
class Ui_Lake_Level_UI(object):
    ...
    def retranslateUi(self, Lake_Level_UI):
        ...
        self.selectlakeDropMenu.setItemText(0, _translate("Lake_Level_UI", "2000", None))
        self.selectlakeDropMenu.setItemText(1, _translate("Lake_Level_UI", "632", None))
        self.selectlakeDropMenu.setItemText(2, _translate("Lake_Level_UI", "1064", None))
        self.selectlakeDropMenu.setItemText(3, _translate("Lake_Level_UI", "595", None))
        self.selectlakeDropMenu.setItemText(4, _translate("Lake_Level_UI", "250", None))
        self.selectlakeDropMenu.setItemText(5, _translate("Lake_Level_UI", "Il'Men'", None))
        self.selectlakeDropMenu.setItemText(6, _translate("Lake_Level_UI", "Edward", None))
        self.selectlakeDropMenu.setItemText(7, _translate("Lake_Level_UI", "Lake Charlevoix", None))
        self.selectlakeDropMenu.setItemText(8, _translate("Lake_Level_UI", "180", None))
        self.selectlakeDropMenu.setItemText(9, _translate("Lake_Level_UI", "170", None))
        self.selectlakeDropMenu.setItemText(10, _translate("Lake_Level_UI", "160", None))
        self.selectlakeDropMenu.setItemText(11, _translate("Lake_Level_UI", "190", None))
